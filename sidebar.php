		  	...
		  	<div class="panel panel-default">
			  <div class="panel-heading">
			    <h3 class="panel-title"><span class="fa fa-file"></span>Data Barang</h3>
			  </div>
			  <div class="panel-body">
			    <ul class="nav nav-pills nav-stacked">
				  <li role="presentation"><a href="mekanik.php"><span class="fa fa-users"></span> Barang Masuk </a></li>
				  <li role="presentation"><a href="sparepart.php"><span class="fa fa-cogs"></span> Barang Keluar</a></li>
				  <li role="presentation"><a href="sparepart.php"><span class="fa fa-cogs"></span> Data Suplayer</a></li>
				</ul>
			  </div>
			</div>
			<div class="panel panel-default">
